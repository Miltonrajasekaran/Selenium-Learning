...
public class hpLaptop {
	...
	public static void main(String[] args) throws InterruptedException {
				...
				//Accept Cookies
				wt.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Accept Cookies']")));
				...
				wt.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("\"//span[text()='More than 1 TB']")));
				...
				wt.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[text()='My Cart'])[1]")));
				...
				wt.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='pincode']")));
				...
				wt.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[text()='Place Order'])[3]")));
